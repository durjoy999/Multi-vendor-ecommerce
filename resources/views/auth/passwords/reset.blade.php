...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 05:27:23 GMT -->
            ...
            <div class="col-lg-6 offset-xl-2">
                <div class="axil-signin-form-wrap">
                    <div class="axil-signin-form">
                        ...
                        <form class="singin-form" action="{{ route('password.update') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label>Email <span class="text-danger">*</span></label>
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email }}">
                                @error('email')
