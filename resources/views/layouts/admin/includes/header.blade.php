        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ asset('files/admin/photo/profile') }}/{{ Auth::guard('admin')->User()->photo }}"
                    alt="Header Avatar">
                    @else
                    <img class="rounded-circle header-profile-user" src="{{ asset('files') }}/{{ Auth::guard('admin')->User()->photo }}"
                    alt="Header Avatar">
                    @endif
