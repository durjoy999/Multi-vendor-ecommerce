                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Reply User Massage</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-center">Reply User Massage </h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 ">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            <form method="post" action="{{ route('admin.userMassage.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="user_id" value="{{ $userMassage->id }}">
                            ...
                            <table class="table mb-0 table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                           {{ date("g:i a", strtotime($userMassage->updated_at ?? 'N/A' )) }}
                                              <br>
                                           {{ date("j F Y", strtotime($userMassage->updated_at ?? 'N/A' )) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><strong> Subject </strong></th>
                                        <td>{{ $userMassage->subject ?? 'N/A' }}</td>
                                    </tr>

                                    <tr>
                                        <th scope="row"><strong> Reply </strong></th>
                                        <td>{{ $userMassage->reply ?? 'N/A' }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
