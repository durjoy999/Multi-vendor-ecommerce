    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Create Quick Link</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.quickLink.index') }}">All Quick Links</a></li>
                            <li class="breadcrumb-item active">Create Quick Link</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.quickLink.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                           ...
                           <div class="form-group mb-4">
                               ...
                               <textarea name="details" id="editor" class="form-control @error('details') is-invalid @enderror" cols="30" rows="3">{{ old('details') }}</textarea>
                               @error('details')
                                   <div class="text-danger">{{ $message }}</div>
                               @enderror
                           </div>
...
@section('admin_js')
    ...
    @if (Session::has('quick_link_created_successfully'))
        <script>
                Toast.fire({
                    icon: 'success',
                    title: "{{ Session::get('quick_link_created_successfully') }}"
                })
        </script>
    @endif
@endsection
