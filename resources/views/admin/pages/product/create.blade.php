        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Create Brand</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea name="short_details" class="form-control @error('short_details') is-invalid @enderror" cols="30" rows="3">{{ old('short_details') }}</textarea>
                                            @error('short_details')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea name="long_details" id="editor" class="form-control @error('long_details') is-invalid @enderror" cols="30" rows="3">{{ old('long_details') }}</textarea>
                                            @error('long_details')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="number" step="any" name="previous_price" class="form-control @error('previous_price') is-invalid  @enderror" value="{{ old('previous_price') }}">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="number" step="any" name="current_price" class="form-control @error('current_price') is-invalid  @enderror" value="{{ old('current_price') }}">
                                            @error('current_price')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <select name="child_category_id"  class="form-select child-category  @error('child_category_id') is-invalid @enderror">
                                                ...
                                                {{-- @foreach ($childCategories as $childCategory)
                                                    <option {{ old('child_category_id') == $childCategory->id?'selected':'' }} value="{{ $childCategory->id }}">{{ $childCategory->name }}</option>
                                                @endforeach --}}
                                            </select>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <select name="tax_id" class="form-select  @error('tax_id') is-invalid @enderror">
                                                ...
                                                @foreach ($taxes as $tax)
                                                    <option {{ old('tax_id') == $tax->id ? 'selected':'' }} value="{{ $tax->id }}">{{ $tax->title }}</option>
                                                @endforeach
                                            </select>
                                            @error('tax_id')
                                                <div class="text-danger">{{ $message }}</div>
...
@section('admin_js')
    ...
    @if (Session::has('product_added_successfully'))
        <script>
                Toast.fire({
                    icon: 'success',
                    title: "{{ Session::get('product_added_successfully') }}"
                })
        </script>
    @endif
