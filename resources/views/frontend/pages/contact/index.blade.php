...
@section('frontend_content')
                ...
                <div class="row row--30">
                    <div class="col-lg-8">
                        <div class="contact-form">
                            ...
                            <form id="contact-form" method="POST" action="{{ route('frontend.contact.store') }}" class="axil-contact-form">
                                @csrf
                                <div class="row row--10">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="massage" id="contact-message" cols="1" rows="2"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group mb--0">
                                            <button  type="submit" id="submit" class="axil-btn btn-bg-primary">Send Message</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    @if (Session::has('message_submit_successfully'))
        <script>
            Toast.fire({
                icon: 'success',
                title: "{{ Session::get('message_submit_successfully') }}"
            })
        </script>
    @endif
    @if ($errors->any())
